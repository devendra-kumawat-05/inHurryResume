      ...
      <div className="min-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          ...
          <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-800">
            ...
            <a href="#features" className="hover:text-[#1A73E8] transition">
              Features
            </a>
            <a href="#testimonials" className="hover:text-[#1A73E8] transition">
              Testimonials
            </a>
            <a href="#cta" className="hover:text-[#1A73E8] transition">
              Contact
            </a>
          </div>
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="hidden md:block px-6 py-2 bg-[#1A73E8] hover:bg-[#1A73E8]/90 active:scale-95 transition-all rounded-full text-white"
            >
              Get started
            </Link>
            <Link
        ...
        >
          ...
          <button
            ...
            className="active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center bg-[#1A73E8] hover:bg-[#1A73E8]/90 transition text-white rounded-md flex"
          >
            X
          </button>
        </div>
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          <div className="absolute top-28 xl:top-10 -z-10 left-1/4 size-72 sm:size-96 xl:size-120 2xl:size-132 bg-[#1A73E8]/90 blur-[100px] opacity-30"></div>
                ...
                {Array(5)
                  ...
                  .map((_, i) => (
                    <svg
                      ...
                      className="lucide lucide-star text-transparent fill-[#1A73E8]"
                      aria-hidden="true"
                    >
          ...
          <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
            ...
            <span className=" bg-gradient-to-r from-[#1A73E8] to-[#4581d0] bg-clip-text text-transparent text-nowrap">
              AI-powered{" "}
            </span>{" "}
            inHurryResume.
          </h1>
          ...
          <p className="max-w-md text-center text-base my-7">
            Create, edit, download and share your resume in seconds with our
            AI-powered resume builder. Save time and focus on what matters.
          </p>
          ...
          <div className="flex items-center gap-4 ">
            <Link
              to="/app"
              className="bg-[#1A73E8] hover:bg-[#1A73E8]/90 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-[#6a95ce] flex items-center transition-colors"
            >
              Get started
              <svg
                xmlns="http://www.w3.org/2000/svg"
