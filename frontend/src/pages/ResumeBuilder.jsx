        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              <button className="bg-gradient-to-br from-blue-100 to-blue-400 ring-blue-300 text-blue-600 ring hover:ring-blue-400 transition-all rounded-md px-6 py-2 mt-6 text-sm">
                Save Changes
              </button>
            </div>
          </div>
            ...
            <div className="relative w-full">
              ...
              <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  className="flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-red-100 to-red-200 text-red-600 rounded-lg ring-red-300 hover:ring transition-colors"
                >
                  {resumeData.public ? (
